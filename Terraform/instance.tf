...
#  template = file("${path.module}/autoscale_template.tpl")
#
#  vars = {
#    flatcar_image_id = data.openstack_images_image_v2.flatcar.id
#    k3s_user_data    = data.ct_config.worker[count.index].rendered
#  }
#}
