...
helm upgrade --kube-insecure-skip-tls-verify  spark bitnami/spark --set master.resourcesPreset=none --set worker.resourcesPreset=none --set image.repository=sarahema/spark-scalable --set image.tag=3.3.0
